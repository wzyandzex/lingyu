...
> 实现状态：**VS0–VS2 已通过基线**；下一焦点 VS3 战斗设计门
...
| G | VS0→VS6 实现 | **进行中（VS0–VS2 Done）** | 每片：设计门→批准→实现→验收 |
...
| VS1 图志目击 | **已通过基线** | 2026-07-21；C002 目击+图志 |
| VS2 结契 | **已通过基线** | 2026-07-21；雾衔静随+Party |
| VS3 战斗 | 可宣告 | Full；教学战；依赖 VS2 |
