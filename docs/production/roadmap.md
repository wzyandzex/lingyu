...
> 更新：2026-07-20  
> 引擎状态：**已锁定 Unity**（ADR-006/007）— 不再「待确认引擎」  
> 实现状态：**业务代码未开始**；规范与仓库卫生已补强（ADR-010）
...
| G | VS0→VS6 实现 | **Not started** | 每片：设计门→批准→实现→验收 |
...
| 切片 | 状态 | 备注 |
|---|---|---|
| VS0 世界壳 | 待设计 | Slim 设计包；见 design-package-profiles |
| VS1 图志目击 | 锁定等待 | 依赖内容 DataDraft |
